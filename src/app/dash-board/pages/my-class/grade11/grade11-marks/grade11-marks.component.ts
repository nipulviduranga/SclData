...
@Component({
  selector: 'app-grade11-marks',
  templateUrl: './grade11-marks.component.html',
  styleUrls: ['./grade11-marks.component.scss']
})
export class Grade11MarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade11Term1';
      this.loadData('Grade11Term1');

    }else if (value === '2nd'){
      this.term = 'Grade10Term2';
      this.loadData('Grade11Term2');

    }else if (value === '3rd'){
      this.term = 'Grade11Term3';
      this.loadData('Grade11Term3');
