...
@Component({
  selector: 'app-grade06-marks',
  templateUrl: './grade06-marks.component.html',
  styleUrls: ['./grade06-marks.component.scss']
})
export class Grade06MarksComponent implements OnInit {
  ...
  getTerm(value: string) {
      if (value === '1st'){
        this.term = 'Grade06Term1';
        this.loadData('Grade06Term1');

      }else if (value === '2nd'){
        this.term = 'Grade06Term2';
        this.loadData('Grade06Term2');

      }else if (value === '3rd'){
        this.term = 'Grade06Term3';
        this.loadData('Grade06Term3');
