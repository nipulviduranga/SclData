...
export class MathsMarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade12MathsTerm1';
      this.loadData('Grade12MathsTerm1');

    }else if (value === '2nd'){
      this.term = 'Grade12MathsTerm2';
      this.loadData('Grade12MathsTerm2');

    }else if (value === '3rd'){
      this.term = 'Grade12MathsTerm3';
      this.loadData('Grade12MathsTerm3');
