...
export class ArtMarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade12ArtTerm1';
      this.loadData('Grade12ArtTerm1');

    }else if (value === '2nd'){
      this.term = 'Grade12ArtTerm2';
      this.loadData('Grade12ArtTerm2');

    }else if (value === '3rd'){
      this.term = 'Grade12ArtTerm3';
      this.loadData('Grade12ArtTerm3');
