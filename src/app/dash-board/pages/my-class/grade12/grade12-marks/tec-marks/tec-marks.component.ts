...
@Component({
  ...
  templateUrl: './tec-marks.component.html',
  styleUrls: ['./tec-marks.component.scss']
})
export class TecMarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade12TecTerm1';
      this.loadData('Grade12TecTerm1');

    }else if (value === '2nd'){
      this.term = 'Grade12TecTerm2';
      this.loadData('Grade12TecTerm2');

    }else if (value === '3rd'){
      this.term = 'Grade12TecTerm3';
      this.loadData('Grade12TecTerm3');
