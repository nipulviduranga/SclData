...
export class BioMarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade12BioTerm1';
      this.loadData('Grade12BioTerm1');

    }else if (value === '2nd'){
      this.term = 'Grade12BioTerm2';
      this.loadData('Grade12BioTerm2');

    }else if (value === '3rd'){
      this.term = 'Grade12BioTerm3';
      this.loadData('Grade12BioTerm3');
