...
@Component({
  selector: 'app-grade07-marks',
  templateUrl: './grade07-marks.component.html',
  styleUrls: ['./grade07-marks.component.scss']
})
export class Grade07MarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade07Term1';
      this.loadData('Grade07Term1');

    }else if (value === '2nd'){
      this.term = 'Grade07Term2';
      this.loadData('Grade07Term2');

    }else if (value === '3rd'){
      this.term = 'Grade07Term3';
      this.loadData('Grade07Term3');
