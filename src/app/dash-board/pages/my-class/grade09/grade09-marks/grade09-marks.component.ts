...
@Component({
  selector: 'app-grade09-marks',
  templateUrl: './grade09-marks.component.html',
  styleUrls: ['./grade09-marks.component.scss']
})
export class Grade09MarksComponent implements OnInit {
  ...
  getTerm(value: string) {
    if (value === '1st'){
      this.term = 'Grade09Term1';
      this.loadData('Grade09Term1');

    }else if (value === '2nd'){
      this.term = 'Grade09Term2';
      this.loadData('Grade09Term2');

    }else if (value === '3rd'){
      this.term = 'Grade09Term3';
      this.loadData('Grade09Term3');
